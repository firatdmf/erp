...
class Command(BaseCommand):
    ...
    def handle(self, *args, **o):
        ...
        with transaction.atomic():
            ...
            for a in accounts:
                # Moving an account used to have to drag its legacy AR/AP
                # mirror rows along too — they carried their own book column
                # and were written only at movement creation, which is how
                # book 1 kept listing receivables for customers whose
