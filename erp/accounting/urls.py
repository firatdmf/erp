...
urlpatterns = [
    ...
    path('books/<int:pk>/shares/', SetBookTotalShares.as_view(), name="set_book_total_shares"),
    path('books/<int:pk>/stakeholders/<int:sb_pk>/shares/', SetStakeholderShares.as_view(), name="set_stakeholder_shares"),
