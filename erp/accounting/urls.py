...
urlpatterns = [
    ...
    path('books/<int:pk>/rename/', RenameBook.as_view(), name="rename_book"),
    path('books/<int:pk>/brand_name/', SetBookBrandName.as_view(), name="set_book_brand_name"),
    path('books/<int:pk>/make_default_cari_target/', SetDefaultCariTarget.as_view(), name="set_default_cari_target"),
    path('books/<int:pk>/work_here/', SetMyWorkingBook.as_view(), name="set_my_working_book"),
    path('books/<int:pk>/shares/', BookShares.as_view(), name="book_shares"),
    path('books/<int:pk>/cash_accounts/new/', AddCashAccount.as_view(), name="add_cash_account"),
    path('books/<int:pk>/cash_accounts/<int:account_pk>/edit/', EditCashAccount.as_view(), name="edit_cash_account"),
    ...
    path('books/<int:pk>/add_fixed_asset/',AddFixedAsset.as_view(),name="add_fixed_asset"),
    path('books/<int:pk>/edit_fixed_asset/<int:asset_pk>/',EditFixedAsset.as_view(),name="edit_fixed_asset"),
