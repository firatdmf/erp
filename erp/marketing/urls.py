...
urlpatterns = [
    ...
    path("api/async_delete_cdn_files/",views.async_delete_cdn_files,name="async_delete_cdn_files"),
    path("api/file-info/<int:file_id>/",views.file_info_api,name="file_info_api"),
